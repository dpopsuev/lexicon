...
4. **Standardize (Seiketsu)** — make rules for maintaining order. Linters, formatters, shared rule definitions.
...
| Shine | Linter clean, formatter run |
| Standardize | Lint config, rule registry, templates |
