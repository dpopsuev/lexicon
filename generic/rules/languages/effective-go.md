...
- `effective-go-extended` — §11–19: function design, options, packages, allocation, init, panic, logging, stdlib, testing
- `code-smells` — structural smells; this rule covers mechanical hygiene.
- `solid-principles` — dependency inversion, single responsibility.
- `testing-methodology` — test layers and coverage matrix.
